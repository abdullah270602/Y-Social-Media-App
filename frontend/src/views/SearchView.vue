      ...
      <div class="flex flex-row justify-center">
        ...
        <div class="w-full sm:w-600 h-screen">
          ...
          <div class="relative mt-6">
            <div
              class="absolute left-3 top-4 bottom-0 my-auto h-full text-gray-600 dark:text-gray-400 cursor-pointer"
            >
              <svg
            ...
            <form @submit.prevent="submitForm">
              <input
                v-model="query"
                class="w-full bg-gray-900 dark:bg-dim-400 border-gray-200 dark:border-dim-400 text-gray-900 focus:bg-gray-100 dark:focus:bg-dim-900 focus:outline-none focus:border focus:border-blue-200 font-normal h-9 pl-12 text-sm rounded-full border shadow dark:text-white"
          ...
          <!-- AccountResults-->
          <div v-if="UserResults.length" class="mt-11">
            <div
          ...
          <!--Post Results-->
          <div v-if="PostResults.length" class="mt-6">
            <div
